...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xeus-python-shell-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13666&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xeus-python-shell-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xeus-python-shell` can be installed with:

```
conda install xeus-python-shell
```

It is possible to list all of the versions of `xeus-python-shell` available on your platform with:
